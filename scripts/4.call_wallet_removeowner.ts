...
async function main() {
    ...
    const removeOwner = accounts[1].address;

    const removeOwnerData = targetContract.interface.encodeFunctionData("removeOwner", [removeOwner]);
    console.log("removeOwner function data:", removeOwnerData);
